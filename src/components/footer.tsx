    ...
    <footer className="bg-black pt-32 pb-16 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="col-span-1 md:col-span-2 space-y-10 text-center md:text-left">
            <Link href="/" className="text-4xl font-black font-headline tracking-tighter group inline-flex items-center gap-3">
              <span className="text-primary group-hover:scale-105 transition-transform">VIKAS</span>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="text-sm font-black italic text-primary text-center tracking-widest hover:scale-110 transition-transform duration-500 cursor-default">
      ...
      <div className="fixed bottom-0 left-0 w-full h-1 flex shadow-[0_-5px_20px_rgba(7,241,214,0.2)]">
